...
function sign_message(private_key, message, compressed, addrtype) {
    ...
    var address = new Bitcoin.Address(private_key.getBitcoinAddress());
...
module.exports.signMessage = function () {
  var args = Array.prototype.slice.apply(arguments, [ 0 ]);
  args[0] = new Bitcoin.ECKey(args[0]);
  sign_message.apply(null, args);
};
